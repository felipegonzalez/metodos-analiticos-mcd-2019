...
Podemos intentar usar un vector de 4 millones de bits con unos 6 hashes. Nuestra
...
# crear filtro
set.seed(812)
filtro_b <- filtro_bloom(num_hashes = 6, n = 4e6)
...
# esto normalmente no lo hacemos desde R
