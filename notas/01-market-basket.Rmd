...
En este ejemplo chico, el cálculo de esta colección (hasta canastas de tamaño 7) 
...
qqplot(quality(filtradas_hl)$support, 
       quality(filtradas_lift)$support, xlab = 'Filtro Hyper-lift',
       ylab = 'Filtro Lift', main = 'Soporte')
```
...
qqplot(quality(filtradas_hl)$lift, 
       ...
       ylab = 'Filtro Lift', main = 'Lift')
```

En resumen, al utilizar *hyper-lift* para filtrar reglas en lugar de *lift*:
